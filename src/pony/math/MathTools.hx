...
class MathTools {
	...
	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function percentBackCalc(p: Float, min: Float, max: Float): Float return (p - min) / (max - min);
	...
	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function inRange(v: Float, min: Float, max: Float): Bool return min <= v && v <= max;

	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function approximately(a: Float, b: Float, range: Float = 1): Bool return inRange(a, b - range, b + range);

	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function limit(v: Float, min: Float, max: Float): Float return if (v < min)
		min;
	else if (v > max)
		max;
	else
	...
	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function cultureAdd(a: Float, b: Float, max: Float): Float return a + b >= max ? max : a + b;

	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function cultureSub(a: Float, b: Float, min: Float): Float return a - b <= min ? min : a - b;
	...
	public static inline function pcMinMax(a: SPair<Int>, b: SPair<Int>): SPair<Int> return new SPair<Int>(cmin(a.a, b.a), cmax(b.a, b.b));

	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function roundTo(v: Float, count: Int): Float return Math.round(v * Math.pow(10, count)) / Math.pow(10, count);

	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function intTo(v: Float, count: Int): Float return Std.int(v * Math.pow(10, count)) / Math.pow(10, count);

	#if (haxe_ver >= 4.2) extern #else @:extern #end
	public static inline function intNot(v: Int): Int return v == 0 ? 1 : 0;
