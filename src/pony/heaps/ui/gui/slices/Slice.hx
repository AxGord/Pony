	...
	public static function create(
		...
		if (src == null) {
			...
			return switch SliceTools.getType(src) {
				case Not() if (repeat): new NodeRepeat(tiles[0], parent);
				case Not(): new NodeBitmap(tiles[0], border, parent);
				case Hor2(): new Slice2H(tiles, repeat, parent);
				case Hor3(): new Slice3H(tiles, repeat, parent);
				case Vert2(): new Slice2V(tiles, repeat, parent);
				case Vert3(): new Slice3V(tiles, repeat, parent);
				case Four(): new Slice4(tiles, repeat, parent);
