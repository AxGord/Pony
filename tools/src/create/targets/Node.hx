...
class Node {
	...
	public static function createNpmPackage(
		...
		final r: NpmPackage = { name: project.rname, version: '0.0.1', main: project.build.getOutputFile(), build: { productName: project.rname } }
		if (dependencies != null) r.setField('dependencies', dependencies.toDynamic());
		if (devDependencies != null) r.setField('devDependencies', devDependencies.toDynamic());
		return r;
	}

	public static function createAndSaveNpmPackageToOutputDir(
		project: Project, ?dependencies: Map<String, String>, ?devDependencies: Map<String, String>
	): Void {
