...
namespace haxe.lang{
	public  class StringExt {
		...
		public static   string toString(string me){
			unchecked {
				#line 181 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
				return me;
			}
			#line default
		}
...
namespace haxe.lang{
	public  class StringRefl {
		...
		public static   object handleGetField(string str, string f, bool throwErrors){
			unchecked {
				...
				switch (f){
					...
					default:
					{
						#line 226 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
						if (throwErrors) {
							#line 227 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
							...
							#line 229 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
		...
		public static   object handleCallField(string str, string f, global::Array args){
			unchecked {
				#line 235 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
				global::Array _args = new global::Array<object>(new object[]{str});
				if (( args == default(global::Array) )) {
					#line 237 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
					args = _args;
				}
				 else {
					#line 239 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
					args = ((global::Array) (global::haxe.lang.Runtime.callField(_args, "concat", 1204816148, new global::Array<object>(new object[]{args}))) );
				}
				
				#line 241 "C:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
