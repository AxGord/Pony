...
Main.firstTest = function() {
	...
	pony.AsyncTests.wait(new IntIterator(0,Main.blockCount),function() {
		haxe.Log.trace("Second part",{ fileName : "Main.hx", lineNumber : 55, className : "Main", methodName : "firstTest"});
		server.close();
		var server1 = Main.createServer();
...
Main.createServer = function() {
	var server = new pony.net.SocketServer(Main.port);
	var this1 = server.connect;
	var listener;
	var l;
	...
	l = pony.events._Listener.Listener_Impl_._fromFunction(f,false);
	listener = l;
	pony.events._Signal1.Signal1_Impl_.add(this1,listener);
	this1;
	var this2 = server.data;
	var listener1;
	var l1;
	var f1 = pony._Function.Function_Impl_.from(function(bi) {
		var i = bi.readInt32();
		pony.AsyncTests.equals("hello user",pony.Tools.readStr(bi),{ fileName : "Main.hx", lineNumber : 75, className : "Main", methodName : "createServer"});
		pony.AsyncTests.setFlag(Main.partCount + i,{ fileName : "Main.hx", lineNumber : 76, className : "Main", methodName : "createServer"});
	},1);
	l1 = pony.events._Listener.Listener_Impl_._fromFunction(f1,false);
	listener1 = l1;
...
Main.createClient = function(i) {
	...
	var this1 = client.data;
	var listener;
	var l;
	var f = pony._Function.Function_Impl_.from(function(data) {
		var s = pony.Tools.readStr(data);
		pony.AsyncTests.assertList.push({ a : s, b : "hi world", pos : { fileName : "Main.hx", lineNumber : 87, className : "Main", methodName : "createClient"}});
		var bo = new haxe.io.BytesOutput();
		bo.writeInt32(i);
		bo.writeInt32("hello user".length);
		bo.writeString("hello user");
		client.send(bo);
		pony.AsyncTests.setFlag(i,{ fileName : "Main.hx", lineNumber : 92, className : "Main", methodName : "createClient"});
		client.socket.end();
		client.socket = null;
		client.closed = true;
	},1);
...
pony._Function.Function_Impl_._new = function(f,count,args) {
	var this1;
	...
	this1 = { f : f, count : count, args : args == null?[]:args, id : pony._Function.Function_Impl_.counter, used : 0};
	return this1;
};
pony._Function.Function_Impl_.from = function(f,argc) {
	if(pony._Function.Function_Impl_.list.exists(f)) return pony._Function.Function_Impl_.list.get(f); else {
		...
		var o = pony._Function.Function_Impl_._new(f,argc);
...
pony.events._Listener.Listener_Impl_._new = function(f,event,ignoreReturn,count) {
	if(count == null) count = -1;
	if(ignoreReturn == null) ignoreReturn = true;
	if(event == null) event = false;
	var this1;
	f.used++;
	this1 = { f : f, count : count, event : event, prev : null, used : 0, active : true, ignoreReturn : ignoreReturn};
	return this1;
};
pony.events._Listener.Listener_Impl_.fromEFunction = function(f) {
	return pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from(f,1),true);
};
pony.events._Listener.Listener_Impl_.fromFunction = function(f) {
	return pony.events._Listener.Listener_Impl_._fromFunction(f,false);
};
pony.events._Listener.Listener_Impl_.fromSignal = function(s) {
	return pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from($bind(s,s.dispatchEvent),1),true);
};
pony.events._Listener.Listener_Impl_._fromFunction = function(f,ev) {
	if(pony.events._Listener.Listener_Impl_.flist.exists(f.id)) return pony.events._Listener.Listener_Impl_.flist.get(f.id); else {
		...
		var this1;
		f.used++;
		this1 = { f : f, count : -1, event : ev, prev : null, used : 0, active : true, ignoreReturn : true};
		o = this1;
...
pony.events._Listener.Listener_Impl_.setCount = function(this1,count) {
	...
	var this2;
	f.used++;
	this2 = { f : f, count : count, event : this1.event, prev : null, used : 0, active : true, ignoreReturn : this1.ignoreReturn};
	return this2;
};
...
pony.events._Listener0.Listener0_Impl_.from0 = function(f) {
	var l;
	var f1 = pony._Function.Function_Impl_.from(f,0);
	l = pony.events._Listener.Listener_Impl_._fromFunction(f1,false);
	return l;
};
pony.events._Listener0.Listener0_Impl_.fromE = function(f) {
	var l = pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from(f,1),true);
	return l;
};
pony.events._Listener0.Listener0_Impl_.from0T = function(f) {
	var l;
	var f1 = pony._Function.Function_Impl_.from(f,1);
	l = pony.events._Listener.Listener_Impl_._fromFunction(f1,false);
	return l;
};
pony.events._Listener0.Listener0_Impl_.fromTE = function(f) {
	var l;
	var f1 = pony._Function.Function_Impl_.from(f,2);
	l = pony.events._Listener.Listener_Impl_._fromFunction(f1,false);
	return l;
};
...
pony.events._Listener1.Listener1_Impl_.from1TE = function(f) {
	var l;
	var f1 = pony._Function.Function_Impl_.from(f,3);
	l = pony.events._Listener.Listener_Impl_._fromFunction(f1,false);
	return l;
};
...
pony.events._Listener1.Listener1_Impl_.fromSignal0 = function(s) {
	...
	l = pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from(f,1),true);
	return l;
};
...
pony.events._Listener2.Listener2_Impl_.from2TE = function(f) {
	var l;
	var f1 = pony._Function.Function_Impl_.from(f,4);
	l = pony.events._Listener.Listener_Impl_._fromFunction(f1,false);
	return l;
};
...
pony.events.Signal.prototype = {
	...
	,once: function(listener,priority) {
		...
		return this.add((function($this) {
			...
			var this1;
			f.used++;
			this1 = { f : f, count : 1, event : listener.event, prev : null, used : 0, active : true, ignoreReturn : listener.ignoreReturn};
			$r = this1;
			return $r;
		}(this)),priority);
	}
	...
	,and: function(signal) {
		...
		var lock1 = false;
		var lock2 = false;
		this.add(pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from(function(e1) {
			if(lock1) return;
			lock2 = true;
			signal.once(pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from(function(e2) {
				lock2 = false;
				ns.dispatchEvent(new pony.events.Event(e1.args.concat(e2.args),_g.target,e1));
			},1),true),null);
		},1),true));
		signal.add(pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from(function(e21) {
			if(lock2) return;
			lock1 = true;
			_g.once(pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from(function(e11) {
				lock1 = false;
	...
	,or: function(signal) {
		var ns = new pony.events.Signal();
		this.add(pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from($bind(ns,ns.dispatchEvent),1),true));
		signal.add(pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from($bind(ns,ns.dispatchEvent),1),true));
		return ns;
	}
	...
	,sw: function(l1,l2,priority) {
		...
		this.once((function($this) {
			...
			$r = pony.events._Listener.Listener_Impl_._fromFunction(f,false);
			return $r;
		}(this)),priority);
		return this;
	}
...
pony.net.SocketClientBase = function(host,port,reconnect) {
...
pony.net.SocketClientBase.prototype = {
	server: null
	,connect: null
	,data: null
	,disconnect: null
	...
	,_init: function() {
		...
		this.data = this2;
		this.disconnect = new pony.events.Signal(this);
	}
	,reconnect: function() {
		if(this.reconnectDelay == 0) {
			haxe.Log.trace("Reconnect",{ fileName : "SocketClientBase.hx", lineNumber : 74, className : "pony.net.SocketClientBase", methodName : "reconnect"});
			this.open();
		}
	}
	,open: function() {
	...
	,endInit: function() {
		this.closed = false;
		if(this.server != null) pony.events._Signal1.Signal1_Impl_.dispatch(this.server.connect,this);
	}
	,init: function(server,id) {
		this._init();
		this.server = server;
		this.id = id;
		pony.events._Signal1.Signal1_Impl_.add(this.data,(function($this) {
			var $r;
			var f = (function(_e) {
				return function(event) {
					return pony.events._Signal1.Signal1_Impl_.dispatchEvent(_e,event);
		...
		this.disconnect.add(pony.events._Listener.Listener_Impl_._fromFunction(pony._Function.Function_Impl_.from(($_=server.disconnect,$bind($_,$_.dispatchEvent)),1),true));
	}
	,send2other: function(data) {
		this.server.send2other(data,this);
	}
	,joinData: function(bi) {
		pony.events._Signal1.Signal1_Impl_.dispatch(this.data,new haxe.io.BytesInput(bi.read(bi.readInt32())));
	}
	,__class__: pony.net.SocketClientBase
};
pony.net.nodejs = {};
pony.net.nodejs.SocketClient = function(host,port,reconnect) {
	pony.net.SocketClientBase.call(this,host,port,reconnect);
};
...
pony.net.nodejs.SocketClient.prototype = $extend(pony.net.SocketClientBase.prototype,{
	...
	,open: function() {
		...
		this.socket.on("connect",$bind(this,this.connected));
	...
	,closeHandler: function() {
		this.disconnect.dispatchArgs([]);
	}
	,connected: function() {
		this.closed = false;
		pony.events._Signal0.Signal0_Impl_.dispatch(this.connect);
	}
	,send: function(data) {
		this.socket.write(data.getBytes().getData());
	}
...
pony.net.SocketClient = function(host,port,reconnect) {
	pony.net.nodejs.SocketClient.call(this,host,port,reconnect);
};
...
pony.net.SocketServerBase = function() {
	...
	this.error = this3;
	this.disconnect = new pony.events.Signal();
	var this4 = pony.events.Signal.create(null);
	this.data = this4;
	this.closed = new pony.events.Signal(this);
	this.clients = [];
	this.disconnect.add((function($this) {
		var $r;
		var f = pony._Function.Function_Impl_.from($bind($this,$this.removeClient),1);
		$r = pony.events._Listener.Listener_Impl_._fromFunction(f,false);
		return $r;
	}(this)));
};
pony.net.SocketServerBase.__name__ = ["pony","net","SocketServerBase"];
pony.net.SocketServerBase.prototype = {
	data: null
	,connect: null
	,closed: null
	,disconnect: null
	...
	,close: function() {
		this.closed.dispatchArgs([]);
		var this1 = this.data;
		this1.destroy();
		this1.target;
		this.data = null;
		var this2 = this.connect;
		this2.destroy();
		this2.target;
		this.connect = null;
		this.closed.destroy();
...
pony.net.nodejs.SocketServer.prototype = $extend(pony.net.SocketServerBase.prototype,{
	server: null
	,bound: function() {
		pony.events._Signal1.Signal1_Impl_.dispatch(this.message,"bound " + Std.string(this.server.address()));
	}
	,connectionHandler: function(c) {
		this.addClient().nodejsInit(c);
	}
	,close: function() {
		pony.net.SocketServerBase.prototype.close.call(this);
